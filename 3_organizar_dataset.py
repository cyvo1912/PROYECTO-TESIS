...
# ============================================================
# SCRIPT 3 - ORGANIZAR DATASET POR CLASES
# ============================================================

SESIONES = [
    {
        "sujeto": "GRABACION 1",
        "json":   r"D:\CODIGO TESIS MEJORADO\dmd-dataset-distraction-gE-28\dmd\gE\28\s2\gE_28_s2_2019-03-15T10;12;30+01;00_rgb_ann_distraction.json",
    },
    {
        "sujeto": "GRABACION 2",
        "json":   r"D:\CODIGO TESIS MEJORADO\dmd-dataset-distraction-gE-29\dmd\gE\29\s2\gE_29_s2_2019-03-15T13;42;24+01;00_rgb_ann_distraction.json",
    },
    {
        "sujeto": "GRABACION 3",
        "json":   r"D:\CODIGO TESIS MEJORADO\dmd-dataset-distraction-gZ-36\dmd\gZ\36\s2\gZ_36_s2_2019-04-09T10;39;38+02;00_rgb_ann_distraction.json",
    },
    {
        "sujeto": "GRABACION 4",
        "json":   r"D:\CODIGO TESIS MEJORADO\dmd-dataset-distraction-gZ-37\dmd\gZ\37\s2\gZ_37_s2_2019-04-08T15;45;15+02;00_rgb_ann_distraction.json",
    },
    {
        "sujeto": "GRABACION 5",
        "json":   r"D:\CODIGO TESIS MEJORADO\dmd-dataset-rgb_ir-gB-10\dmd\gB\10\s2\gB_10_s2_2019-03-11T15;15;21+01;00_rgb_ann_distraction.json",
    },
]

# ============================================================
# RUTAS DE FRAMES Y SALIDA
# ============================================================

frames_procesados_path = r"D:\CODIGO TESIS MEJORADO\frames_procesados"
frames_aumentados_path = r"D:\CODIGO TESIS MEJORADO\frames_aumentados"
output_path            = r"D:\CODIGO TESIS MEJORADO\dataset_final"
    ...
    for accion_id in acciones:
        ...
        for intervalo in intervalos:
            ...
            for frame_real in range(inicio_redondeado, fin + 1, 10):
                ...
                # Nombre con prefijo de sujeto (igual que Script 2)
...
print(f"\n{'='*60}")
print("  DATASET ETIQUETADO GENERADO")
print(f"{'='*60}")
